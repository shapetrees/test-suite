  ...
  describe(`test/example/photoAlbum-shallow.test.js installed in ${installDir}`, function () {
    ...
    describe(`create ${Path.join('/', installDir, '/')}Albums2019/ hierarchy`, () => {
      describe(`create ${Path.join('/', installDir, '/')}Albums2019/`, () => {
        H.plant({path: Path.join('/', installDir, '/'), slug: 'Albums2019', name: 'PhotoAlbumApp', url: 'http://store.example/PhotoAlbumApp', shapeTreePath: 'album/PhotoAlbumShapeTree#root',
